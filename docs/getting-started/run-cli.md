...
```
$ geth [|--classic|--testnet|--rinkeby|--goerli] console
```
...
ETHEREUM OPTIONS:
  ...
  --networkid value                   Explicitly set network id (integer)(For testnets: use --ropsten, --rinkeby, --goerli, --yolov2 instead) (default: 1)
